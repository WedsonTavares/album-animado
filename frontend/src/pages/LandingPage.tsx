  ...
  return (
    <ClickSpark sparkColor="#8b5cf6" sparkCount={12} sparkRadius={20}>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="flex justify-center items-center py-8 mb-10 overflow-hidden">
          <BounceCards
            images={cardImages}
            containerWidth={600}
            containerHeight={300}
      ...
      <section className="py-16 border-y border-border">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
          <div className="text-center">
            <strong className="block text-3xl font-bold gradient-text">3 min</strong>
            <span className="text-muted-foreground text-sm">para criar um álbum</span>
          </div>
          <div className="hidden md:block w-px h-12 bg-border" />
          <div className="text-center">
            <strong className="block text-3xl font-bold gradient-text">100%</strong>
            <span className="text-muted-foreground text-sm">controle dos dados</span>
          </div>
          <div className="hidden md:block w-px h-12 bg-border" />
          <div className="text-center">
            <strong className="block text-3xl font-bold gradient-text">∞</strong>
            <span className="text-muted-foreground text-sm">memórias guardadas</span>
          </div>
        </div>
      </section>
