  ...
  return (
    <AnimatePresence>
      {open && (
        ...
        >
          <motion.div
            className={`bg-card border border-border rounded-xl sm:rounded-2xl shadow-2xl w-full max-h-[90vh] overflow-y-auto ${size === 'large' ? 'max-w-2xl' : 'max-w-md'}`}
          ...
          >
            ...
            {footer && (
              <div className="flex justify-end gap-2 sm:gap-3 p-4 sm:p-6 pt-0">
                {footer}
              </div>
            )}
          </motion.div>
